...
public class WordListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		WordsContent.loadItems();
		setListAdapter(new ArrayAdapter<Word>(getActivity(),
				android.R.layout.simple_list_item_activated_1,
				android.R.id.text1, WordsContent.getItems()));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(WordsContent.getItems()[position].getText());
	}
