...
public class FontManager {
	// This function enumerates all fonts on Android system and returns the
	// HashMap with the font
	// absolute file name as key, and the font literal name (embedded into the
	// font) as value.
	static public HashMap<String, String> enumerateFonts() {
		...
		for (String fontdir : fontdirs) {
			...
			for (File file : files) {
				String fontname = analyzer.getTtfFontName(file
						.getAbsolutePath());
